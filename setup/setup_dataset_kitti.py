...
# Create output directories for text files containing paths
...
'''
Create validity maps and paths for sparse for training
'''
...
for refdir in ['train', 'val']:
    ...
    for sequence_dirpath in sparse_depth_sequence_dirpath:
        ...
        for camera_dirpath in ['image_02', 'image_03']:
            ...
            # Construct ground truth dirpaths
            ...
            for idx in range(len(sparse_depth_paths)):
                ...
                pool_inputs.append(
                    (image0_path, image1_path, image2_path, sparse_depth_path, ground_truth_path))
...
print('Storing unused ground truth file paths into: %s' %
...
print('Storing clean training ground truth file paths into: %s' %
...
'''
Create validity maps and paths for sparse for validation and testing
'''
...
for mode in modes:
    mode_type, \
        ...
        ground_truth_output_paths = mode

    # Iterate through sparse depth and ground truth directories
...
print('Storing validation ground truth file paths into: %s' %
