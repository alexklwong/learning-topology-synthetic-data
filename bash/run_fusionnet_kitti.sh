...
--restore_path pretrained_models/fusionnet/kitti/retrained/fusionnet.ckpt-kitti \
--image_path validation/kitti/kitti_val_image.txt \
--input_depth_path validation/kitti/kitti_val_predict_depth.txt \
...
--save_outputs \
--output_path pretrained_models/fusionnet/kitti/retrained/outputs/kitti \
--n_thread 4
